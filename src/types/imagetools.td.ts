// with imagetools we add query paramters to image imports
// typescript doesn't like this because it doesn't recognize the image location
// we hack around it by appending an "imagetools" parameter and matching the typing in this type definition using an asterisk "*"
// source: https://github.com/JonasKruckenberg/imagetools/issues/160
